...
//     {
//         intercept.intercept.y = floor(p_pos.y / TILE_SIZE) * TILE_SIZE + TILE_SIZE;
//         intercept.inter_dir = South;
//         step.y = TILE_SIZE;
//     }
//     else
//     {
//         intercept.intercept.y = floor(p_pos.y / TILE_SIZE) * TILE_SIZE - EPSILON;
...
//     if (fabs(slope) > 1e-10)
//     {
//         intercept.intercept.x = p_pos.x + (intercept.intercept.y - p_pos.y) / slope;
//         step.x = step.y / slope;
//     }
//     else
//     {
...
// t_intercept_hit get_vertical_intersection(t_game *game, t_coord p_pos, double ray_angle)
// {
//     double          slope;
//     t_intercept_hit intercept;
//     t_coord         step;
...
//     {
//         intercept.intercept.x = floor(p_pos.x / TILE_SIZE) * TILE_SIZE + TILE_SIZE;
//         intercept.inter_dir = East;
//         step.x = TILE_SIZE;
//     }
//     else
//     {
//         intercept.intercept.x = floor(p_pos.x / TILE_SIZE) * TILE_SIZE - EPSILON;
//         intercept.inter_dir = West;
//         step.x = -TILE_SIZE;
//     }
    
//     intercept.intercept.y = p_pos.y + (intercept.intercept.x - p_pos.x) * slope;
//     step.y = step.x * slope;
...
// t_intercept_hit check_intersection_hit(t_game *game, t_intercept_hit intercept, t_coord step)
// {
//     while (true)
//     {
