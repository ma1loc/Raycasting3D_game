...
# CFLAGS = -Wall -Wextra -Werror $(INCLUDE) $(MLX_INCLUDE) -g3 -fsanitize=address
...
SRC = parsing/get_next_line.c parsing/get_next_line_utils.c parsing/read_map.c \
	...
	raycasting/init_config/init_player_config.c raycasting/init_config/init_player_position.c raycasting/init_config/init_game_config.c \
